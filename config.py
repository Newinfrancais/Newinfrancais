...
PRIORITY_KEYWORDS = [
    "urgent", "breaking", "alerte", "attentat", "seisme", "tremblement",
    "guerre", "cessez-le-feu", "election", "demission", "mort", "deces",
    "crash", "explosion", "tsunami", "ouragan", "tempete",
    "krach", "recession", "inflation", "BCE", "Fed", "OTAN", "NATO",
